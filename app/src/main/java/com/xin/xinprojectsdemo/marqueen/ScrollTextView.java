...
public class ScrollTextView extends ViewGroup {
    ...
    public void setText(String text) {
        ...
        LayoutInflater inflater = (LayoutInflater) getContext().getSystemService(getContext()
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (flag && text != null) {
            ...
            if (length * textSize >= measuredWidth) {
                ...
                int lineCount = (int) ((length % textCountInOneLine == 0) ? (length / textCountInOneLine) :
                        (length / textCountInOneLine + 1));
                Log.i("AAA", "length:" + length + " textCountInOneLine:" + textCountInOneLine + " " +
                        "lineCount:" + lineCount);
