...
import com.xin.xinprojectsdemo.view.MyGridView;
...
public class CityListAdapter extends BaseAdapter {
    ...
    public CityListAdapter(Context context, List<City> allCityList, List<City> hotCityList, List<String> recentCityList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (viewType == 0) {//view类型为0，也就是：当前定位城市的布局
            convertView = View.inflate(mContext, R.layout.item_location_city, null);
            ...
            if (position >= 1) {
                ...
                String previewStr = (position - 1) >= 0 ? getAlpha(mAllCityList.get(position - 1).getPinyin()) : " ";
